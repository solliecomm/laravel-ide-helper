...
class MetaCommandTest extends TestCase
{
    public function testCommand(): void
    {
        ...
        self::assertStringContainsString('namespace PHPSTORM_META {', $this->mockFilesystemOutput);
        self::assertStringContainsString('PhpStorm Meta file, to provide autocomplete information for PhpStorm', $this->mockFilesystemOutput);
