 ...
 * @method static PostExternalQueryBuilder<Post> withBool(bool|null $booleanVar)
 * @method static PostExternalQueryBuilder<Post> withBoolDifferently(bool|null $booleanVar)
 * @method static PostExternalQueryBuilder<Post> withBoolTypeHinted(bool $booleanVar)
 * @method static PostExternalQueryBuilder<Post> withMixedOption(mixed $option)
 ...
 * @method static PostExternalQueryBuilder<Post> withNullTestCommandInDocBlock(\Sollie\LaravelIdeHelper\Console\ModelsCommand $testCommand)
 * @method static PostExternalQueryBuilder<Post> withSomeone(int|string $someone)
