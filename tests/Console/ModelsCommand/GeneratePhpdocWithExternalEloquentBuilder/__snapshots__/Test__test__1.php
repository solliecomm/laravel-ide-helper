 ...
 * @method static \Sollie\LaravelIdeHelper\Tests\Console\ModelsCommand\GeneratePhpdocWithExternalEloquentBuilder\Builders\PostExternalQueryBuilder<Post> withBool(bool|null $booleanVar)
 * @method static \Sollie\LaravelIdeHelper\Tests\Console\ModelsCommand\GeneratePhpdocWithExternalEloquentBuilder\Builders\PostExternalQueryBuilder<Post> withBoolDifferently(bool|null $booleanVar)
 ...
 * @method static \Sollie\LaravelIdeHelper\Tests\Console\ModelsCommand\GeneratePhpdocWithExternalEloquentBuilder\Builders\PostExternalQueryBuilder<Post> withMixedOption(mixed $option)
 ...
 * @method static \Sollie\LaravelIdeHelper\Tests\Console\ModelsCommand\GeneratePhpdocWithExternalEloquentBuilder\Builders\PostExternalQueryBuilder<Post> withNullTestCommandInDocBlock(\Sollie\LaravelIdeHelper\Console\ModelsCommand $testCommand)
 * @method static \Sollie\LaravelIdeHelper\Tests\Console\ModelsCommand\GeneratePhpdocWithExternalEloquentBuilder\Builders\PostExternalQueryBuilder<Post> withSomeone(int|string $someone)
 ...
 * @method static \Sollie\LaravelIdeHelper\Tests\Console\ModelsCommand\GeneratePhpdocWithExternalEloquentBuilder\Builders\PostExternalQueryBuilder<Post> withTheNumber(int|null $number)
 * @method static \Sollie\LaravelIdeHelper\Tests\Console\ModelsCommand\GeneratePhpdocWithExternalEloquentBuilder\Builders\PostExternalQueryBuilder<Post> withTheNumberDifferently(int|null $number)
 */
